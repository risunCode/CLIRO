...
func SyncCodexAccountToKiloAuth(account config.Account) (KiloAuthSyncResult, error) {
...
func SyncCodexAccountToOpencodeAuth(account config.Account) (OpencodeAuthSyncResult, error) {
...
func SyncCodexAccountToCodexCLI(account config.Account) (CodexAuthSyncResult, error) {
...
func mergeOAuthOpenAIObject(raw json.RawMessage, account config.Account, syncedExpires int64, typeValue string, forceType bool, fileLabel string) (json.RawMessage, bool, error) {
	openAICreated := false
