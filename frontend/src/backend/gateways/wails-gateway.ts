import * as client from '@/backend/client/wails-client'
import type { WailsAccount, WailsAppState, WailsCodexAuthSessionView, WailsCodexAuthStart, WailsKiroAuthStart, WailsLogEntry } from '@/backend/models/wails'
